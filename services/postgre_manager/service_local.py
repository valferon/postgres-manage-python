...
import os
import shutil
from services.postgre_manager import PostgreSQLManagerService
...
class PostgreSQLManagerServiceLocal(PostgreSQLManagerService):
    ...
    def __init__(self, config_obj, verbose_mode):
        ...
        self.local_backup_path = config_obj.get('local_storage', 'path', fallback='./backups/')
    ...
    def store_backup(self, compressed_file):
        ...
        shutil.move(compressed_file, '{}{}'.format(self.local_backup_path, self.filename_compressed))
